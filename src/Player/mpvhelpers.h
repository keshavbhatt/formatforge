...
public:                                                                        \
  Q_PROPERTY(                                                                  \
      bool varName READ varName WRITE set_##varName NOTIFY varName##Changed)   \
public Q_SLOTS:                                                                \
  bool varName() const { return getProperty(p).toBool(); }                     \
...
public:                                                                        \
  Q_PROPERTY(                                                                  \
      int varName READ varName WRITE set_##varName NOTIFY varName##Changed)    \
public Q_SLOTS:                                                                \
  int varName() { return getProperty(p).toInt(); }                             \
...
public:                                                                        \
  Q_PROPERTY(                                                                  \
      double varName READ varName WRITE set_##varName NOTIFY varName##Changed) \
public Q_SLOTS:                                                                \
  double varName() { return getProperty(p).toDouble(); }                       \
...
public:                                                                        \
  Q_PROPERTY(QString varName READ varName WRITE set_##varName NOTIFY           \
                 varName##Changed)                                             \
public Q_SLOTS:                                                                \
  QString varName() { return getProperty(p).toString(); }                      \
...
public:                                                                        \
  Q_PROPERTY(QVariantList varName READ varName WRITE set_##varName NOTIFY      \
                 varName##Changed)                                             \
public Q_SLOTS:                                                                \
  QVariantList varName() { return getProperty(p).toList(); }                   \
...
public:                                                                        \
  Q_PROPERTY(QVariantMap varName READ varName WRITE set_##varName NOTIFY       \
                 varName##Changed)                                             \
public Q_SLOTS:                                                                \
  QVariantMap varName() { return getProperty(p).toMap(); }                     \
...
#define WATCH_PROP_BOOL(p) mpv_observe_property(mpv, 0, p, MPV_FORMAT_FLAG);
#define WATCH_PROP_DOUBLE(p) mpv_observe_property(mpv, 0, p, MPV_FORMAT_DOUBLE);
#define WATCH_PROP_INT(p) mpv_observe_property(mpv, 0, p, MPV_FORMAT_INT64);
#define WATCH_PROP_STRING(p) mpv_observe_property(mpv, 0, p, MPV_FORMAT_STRING);
#define WATCH_PROP_ARRAY(p)                                                    \
  mpv_observe_property(mpv, 0, p, MPV_FORMAT_NODE_ARRAY);
#define WATCH_PROP_MAP(p) mpv_observe_property(mpv, 0, p, MPV_FORMAT_NODE_MAP);
